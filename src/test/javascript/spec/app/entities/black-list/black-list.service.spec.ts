...
describe('Service Tests', () => {
    ...
    describe('BlackList Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BlackListService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/black-lists/' + 123);
            });
            it('should return BlackList', () => {

                let entity: BlackList;
                service.find(123).subscribe((_entity: BlackList) => {
                    entity = _entity;
                });
